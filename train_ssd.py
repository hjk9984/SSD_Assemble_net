...
from vision.ssd.assemble_vgg import create_assemble_vgg_ssd
...
parser.add_argument('--base_net', default="./models/pretrained_vgg16.pth",
...
parser.add_argument('--t_max', default=400, type=float,
...
if __name__ == '__main__':
    ...
    if args.net == 'vgg16-ssd':
        ...
        create_net = create_assemble_vgg_ssd
        config = vgg_ssd_config
    else:
